...
export const companyDetails = {
  ...
  twitter: "https://x.com/appinventiv",
};
...
export const reviews = [
  ...
  },
  {
    ...
    desc: "“The architectural solutions from Appinventiv have completely transformed our operations. Their team helped us automate complex data processes, which has freed up our resources for strategic growth. The insights and predictive analytics they’ve provided have given us a clear competitive edge.”",
  },
  {
    id: 3,
    profileImg: profileImg2,
    ...
    desc: "“The conversational agent that Appinventiv developed for us has been a game-changer. It’s efficient, intuitive, and our users are more engaged than ever with the immediate response times. We’re seeing a significant drop in support tickets and a rise in customer satisfaction.”",
  },
  {
    id: 4,
    profileImg: profileImg1,
    ...
    desc: "“Working with Appinventiv on our analytical strategy was a high-value investment. Their experts transformed our raw datasets into actionable intelligence that has guided our recent expansion. We’ve already seen measurable results within the first quarter.”",
  },
  {
    id: 5,
    profileImg: profileImg2,
    ...
    desc: "“The gaming environment Appinventiv built exceeded our technical expectations. From character mechanics to backend lobby management, every detail was handled with precision. Our player retention metrics have spiked significantly!”",
  },
  {
    id: 6,
    profileImg: profileImg1,
    ...
    desc: "“We were navigating the complexity of decentralized systems, and Appinventiv provided the clarity we needed. They developed a secure, immutable ledger solution tailored to our unique compliance needs, giving our clients total confidence.”",
  },
  {
    id: 7,
    profileImg: profileImg2,
    ...
    desc: "“Thanks to Appinventiv, we’ve integrated adaptive learning into our core platforms, providing a new dimension of insight into market behavior. Their hands-on approach and technical depth made the integration seamless.”",
  },
  {
    id: 8,
    profileImg: profileImg1,
    ...
    desc: "“The infrastructure modernization we received from Appinventiv has been foundational. They took us from legacy hardware to a resilient cloud environment, allowing us to scale dynamically. It’s been a massive win for our technical team.”",
  },
  {
    id: 9,
    profileImg: profileImg2,
    ...
    desc: "“Implementing advanced automation with Appinventiv has redefined our day-to-day workflow. Critical tasks are now handled with zero error rates, allowing our staff to focus on higher-level logistics. The efficiency gains have been immediate and sustained.”",
  },
];
