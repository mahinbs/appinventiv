    ...
    <div className="py-[5rem] bg-backgroundcolor text-primarytextcolor">
      ...
      >
        ...
        <h2 data-aos="fade-up" className="heading-2 max-w-[50rem]">
          Engineering Specialized Digital Capabilities
        </h2>
        <p data-aos="fade-up" className="desc max-w-[50rem]">
          Our technical services are designed to address the unique 
          engineering challenges of modern business. We focus on building 
          resilient, high-performance systems that provide a sustainable 
