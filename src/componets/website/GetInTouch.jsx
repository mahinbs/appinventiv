      ...
      <div className="wrapper grid grid-cols-1 lg:grid-cols-2 justify-items-center lg:justify-items-stretch items-center gap-7">
        <div className="flex flex-col gap-5">
          <h1 className="heading-2 text-center text-lg font-medium lg:text-start">
            Ready to Architect Your Next Solution? <br /> Let’s Begin the Discovery
          </h1>
          <p className="description text-center lg:text-start">
            Connect with our engineering team to explore how our specialized 
            technical services can accelerate your operational goals.
          </p>
          <img
            src={image}
            alt=""
        ...
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="bg-gradient-to-b text-white from-primary to-primary rounded-2xl w-fit p-7">
            <h2 className="text-3xl font-medium">
              Expert Consultation for Your Digital Future
            </h2>
            <form
